...
WoowzsiteSourceAlchemy = AddTableToTable(AddFullnessToTable([
	...
	"таулепт","мюон","_","that_end","that_end2","жидкость","газ","гелий","литий","бериллий","бор","углерод","азот","кислород","фтор","неон","натрий","магний"
],"alchemy/",".png"),AddFullnessToTable([
	"в","большой_взрыв","эм","электр","атом","мол","бож","взрыв","эл","таунейт","о","взрыв_ядерный"
],"alchemy/",".gif"))
...
"б","г","д","е","ё","ж","з","и","к","л","и","н","о","э","ю","я","ы","ь","ъ","卐","пвз","вайлдберис","хоп","кодиум","нейронная","радиация","вич","вам что-бы выиграть, вам нужно заплатить 3.000$"]