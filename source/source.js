...
WoowzsiteSourceRandomSite = AddTableToTable(AddTableToTable(AddFullnessToTable([
	...
	"swag","whasapa2","hq720","images","8f5b846b77ca5e3d6cf4cae08416c31a","20250328_094038"
...
WoowzsiteSourceIcons = AddFullnessToTable([
	...
	"ops","allblack","all","eye","dex","bloodeye","xxx","null","griffer","search2","search","skull","wsc","ww","wm_category","chrome","al","lu"
],"source/",".ico")
...
GitExplorerSource = AddTableToTable(AddFullnessToTable([
	...
	"image_tif","image_ico","image_cur","image_dds","file_project","image_pdn","image_psd","file_gitignore","file_vcxproj"
],"ge/",".png"),
	["ge/pdn/image_gif.gif"]
)
...
WoowzsiteSourceFonts = AddFullnessToTable([
	"minecraft.ttf","Comfortaa.ttf","inkverse.ttf","topor.otf","concrete.otf","bloodraw/minecraft.ttf"
],"source/","")
...
"VNNet запрашивает новые разрешения⚠","сын сутенёра","ау","ауууу","асемблер","git","характеризуй себя","сыновья","барак","хули","аеро","эхо","войны","драйвер","драйвера","opengl","OpenGL","Vulkan","iLovePDF"]